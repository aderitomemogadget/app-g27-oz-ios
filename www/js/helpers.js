	...
	$.ajax({
		...
		success:function(data)
		{
			...
			else
			{
				...
				if(estado == 7)
				{
					show_erro('Não foi possível fazer o pagamento, Cliente Bloqueado Contacte OZ Pay.',2000);
				}
				if(estado == 8)
				{
...
function showPinScreen()
{
	...
	html += '<div class="container container-pin" style="height:100%;background:#fff;margin-top:0px;box-shadow:1px 0px 1px 0px #ccc">';
		...
		html += '<form action="" method="" name="vform">';
			...
			html += '</div>';
		html += '</form>';
		html += '<div class="introduza-pin-label"><div class="introduza-pin-label-trad">Introduza o seu <b>PIN OZ Pay</b></div></div>';
	html+= '</div>';
